  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SliverAppBar(
      ...
      actions: [
        IconButton(
          icon: Icon(
            series.isVaulted ? Icons.lock_open_rounded : Icons.lock_outline_rounded,
            color: series.isVaulted ? AppColors.primary : AppColors.onSurface,
          ),
          onPressed: () async {
            ...
            if (context.mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    series.isVaulted ? 'Removed from vault' : 'Moved to vault',
                  ),
